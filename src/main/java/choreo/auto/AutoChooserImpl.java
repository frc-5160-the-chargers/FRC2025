 ...
 *
 * <p>Once the {@link AutoChooserImpl} is made you can add {@link AutoRoutine}s to it using {@link
 ...
 */
public class AutoChooserImpl implements Sendable {
    ...
    private Function<String, String> overrideSelected = null;

    /** Constructs a new {@link AutoChooserImpl}. */
    public AutoChooserImpl() {}

    public void setOnSelectOverride(Function<String, String> override) {
        overrideSelected = override;
    }
    ...
    private String select(String selectStr, boolean force) {
        ...
        if (overrideSelected != null) {
            selected = overrideSelected.apply(selected);
        }
     ...
     * @see AutoChooserImpl#addRoutine
     */
