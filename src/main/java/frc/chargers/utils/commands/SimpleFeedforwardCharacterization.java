package frc.chargers.utils.commands;
...
public class SimpleFeedforwardCharacterization extends Command {
	 ...
	 * @author Kevin Wayne
	 */
	private static class PolynomialRegression implements Comparable<PolynomialRegression> {
	...
	public SimpleFeedforwardCharacterization(
