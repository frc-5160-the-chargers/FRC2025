 ...
 *
 * <p>Once the {@link choreo.auto.AutoChooser} is made you can add {@link AutoRoutine}s to it using {@link
...
public class AutoChooser implements Sendable {
  ...
  /** Constructs a new {@link choreo.auto.AutoChooser}. */
  public AutoChooser() {}
  ...
  public void initSendable(SendableBuilder builder) {
    ...
    builder.publishConstInteger(".instances", 0);
    ...
    builder.addStringProperty("active", () -> activeCommandName, null);
  }
}
