...
public record Setpoint(Distance elevatorHeight, Angle wristTarget, boolean isParallel, String name) {
	private static final Map<Integer, Setpoint> LEVEL_TO_SETPOINT_MAP = Map.ofEntries(
		...
		entry(4, new Setpoint(Meters.of(1.27), Degrees.of(20), true, "L4")) // highest possible elevator setpoint
	);
	
	public static final Setpoint STOW_LOW = new Setpoint(Meters.zero(), Degrees.of(-30), false, "stow low");
	public static final Setpoint STOW_MID = new Setpoint(Meters.of(0.2), Degrees.of(-30), false, "stow mid");
	public static final Setpoint INTAKE = new Setpoint(Meters.of(0.2), Degrees.of(-35), true, "intake");
